...
function Form({visible, onClose}) {
  ...
  return (
    <div id='container' onClick={handleOnClose} className='fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex justify-center items-center'>
        ...
        <div className="p-2 justify-start grid md:grid-cols-2 mx-5 ">
        ...
        <div className='flex items-center '>
            ...
            <div class="relative mt-2 rounded-md shadow-sm">
                ...
                <input type="text" name="cardnumber" id="number" className="mb-4 p-1 w-full rounded-md border-2  sm:text-sm pr-2" placeholder="********"/>
