  ...
  return (
    ...
    <div className='bg-white px-4 py-2 rounded-md w-[350px] md:w-[400px]'>
        <h2 className='text-4xl font-bold text-center pt-4'>LPG</h2>
            ...
            <Link to='/vendor'><button className='w-full py-2 mt-5 bg-green-600 hover:bg-green-500 relative text-white rounded-full'>Sign Up</button></Link>
            <Checkbox label="Remember Me" color="green"/>
            <div className='flex items-center justify-between'>
                        <p className='ml-[94px] md:ml-[144px]'>Already a Member?  Then</p><Link to='/'><button className='w-[60px] py-1 relative text-black rounded-full bg-white underline'>Log In!</button></Link>
                </div>
        </div>
    </div>
    </div>
